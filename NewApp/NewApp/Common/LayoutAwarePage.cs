...
namespace NewApp.Common
{
    ...
    public class LayoutAwarePage : LoadingPage
    {
        /// <summary>
        ...
        public LayoutAwarePage()
        {
            ...
            this.Loaded += (sender, e) =>
            {
                ...
                //Set register the AppData feeds to the page feeds, 
                //to allow the page to monitor feeds status and display progress bar accordingly
                this.Feeds = AppData.Default;

                //TODO: Uncomment this if you want all app pages to be RightToLeft
